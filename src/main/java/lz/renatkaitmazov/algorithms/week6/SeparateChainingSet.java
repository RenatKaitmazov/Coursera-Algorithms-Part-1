...
public final class SeparateChainingSet<T> implements Set<T> {
    ...
    private static final class SeparateChainingSetIterator<T> implements Iterator<T> {
        ...
        @SuppressWarnings("unchecked")
        SeparateChainingSetIterator(SeparateChainingSet set) {
            this.size = set.size;
            items = (T[]) new Object[set.size];
